...
public class DynamoAppConfigElementDaoTest {
    ...
    public void getMostRecentElementsIncludeDeleted() {
        ...
        when(mockMapper.batchLoad(any(List.class))).thenReturn((Map) appConfigElementMapId1And2());
    ...
    private Map<String, List<DynamoAppConfigElement>> appConfigElementMapId1And2() {
        // Regarding the map structure, from the javadocs: "A map of the loaded objects.
        // Each key in the map
        // is the name of a DynamoDB table. Each value in the map is a list of objects
        // that have been loaded
        // from that table. All objects for each table can be cast to the associated
        // user defined type that
        // is annotated as mapping that table." Given our queries on a single table,
