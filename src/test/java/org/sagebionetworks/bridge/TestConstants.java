...
public class TestConstants {
        ...
        public static final String ENCRYPTED_HEALTH_CODE = new org.sagebionetworks.bridge.crypto.CorrectAesGcmEncryptor(
        ...
        public static final byte[] MOCK_MD5 = { -104, 10, -30, -37, 25, -113, 92, -9, 69, -118, -46, -87, 11, -14, 38,
                        -61 };
        ...
        /**
         * During tests, must sometimes pause because the underlying query uses a
         * DynamoDB global
        ...
        public static final Map<SubpopulationGuid, ConsentStatus> CONSENTED_STATUS_MAP = new ImmutableMap.Builder<SubpopulationGuid, ConsentStatus>()
                        .put(SubpopulationGuid.create(REQUIRED_SIGNED_CURRENT.getSubpopulationGuid()),
                                        REQUIRED_SIGNED_CURRENT)
                        .build();
        public static final Map<SubpopulationGuid, ConsentStatus> UNCONSENTED_STATUS_MAP = new ImmutableMap.Builder<SubpopulationGuid, ConsentStatus>()
                        .put(SubpopulationGuid.create(REQUIRED_UNSIGNED.getSubpopulationGuid()), REQUIRED_UNSIGNED)
                        .build();
        ...
        public static final SubpopulationGuid SUBPOP_GUID = SubpopulationGuid
                        .create(REQUIRED_UNSIGNED.getSubpopulationGuid());
        ...
        public static final Activity ACTIVITY_1 = new Activity.Builder().withGuid("activity1guid")
                        .withLabel("Activity1")
                        .withPublishedSurvey("identifier1", "AAA").build();

        public static final Activity ACTIVITY_2 = new Activity.Builder().withGuid("activity2guid")
                        .withLabel("Activity2")
        ...
        public static final List<Label> LABELS = ImmutableList.of(new Label("en", "English"),
                        new Label("fr", "French"));
        public static final List<NotificationMessage> MESSAGES = ImmutableList.of(
                        new NotificationMessage.Builder().withLang("en").withSubject("English").withMessage("Body")
                                        .build(),
                        new NotificationMessage.Builder().withLang("fr").withSubject("French").withMessage("Body")
                                        .build());
        ...
        public static final DateTime ADHERENCE_STATE_NOW = CREATED_ON.plusDays(10)
